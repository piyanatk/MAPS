...
sub writeLayoutFile_dipole_gp{
    ...
    ($r1,$r2) = gaussRand(); printf FP "-1.6065 -1.6065 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP "-0.5355 -1.6065 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP " 0.5355 -1.6065 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP " 1.6065 -1.6065 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP "-1.6065 -0.5355 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP "-0.5355 -0.5355 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP " 0.5355 -0.5355 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP " 1.6065 -0.5355 0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP "-1.6065 0.5355  0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
    ($r1,$r2) = gaussRand(); printf FP "-0.5355 0.5355  0.0 4 %.5g\t% .5g\t0.0 0.35 1.0 0.0 90.0 0.35\n",1.0+$r1*$gainerr,$r2*$phaserr;
...
for(my $ant=0;$ant<$ARGV[0]; $ant++) {
    # make a filename
    my $filename = sprintf("%s%03d.layout","lfd_crossdipole_gp",$ant);
