...
set nokey
set nolabel
set label 1 "h_i = 350 km" at 6, 1.9, 0 left norotate
set label 2 "Delta h = 500 km" at 6, 1.75, 0 left norotate
set label 3 "n_e(h_i) = 10^{12} m^{-3}" at 6, 1.6, 0 left norotate
set label 4 "f = 100 MHz" at 6, 1.45, 0 left norotate
set noarrow
set nolinestyle
set nologscale
set offsets 0, 0, 0, 0
...
set ylabel "Delta zenith angle (arc min)" 0.000000,0.000000  ""
